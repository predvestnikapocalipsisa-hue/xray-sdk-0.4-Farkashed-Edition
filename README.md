...
### Основные преимущества:
    ...
    Сборка: Для сборки проекта в Visual Studio 2022 вам потребуется установленная рабочая нагрузка "Разработка классических приложений на C++", а также обязательно отмеченные в меню дополнительных компонентов "Средства сборки C++ для VS 2019 (v142)" и актуальный Windows SDK.
...
### Список изменений:
    ...
    Обджект лист автоматом фокусируется на выбранном обьекте как это было в оригинальном сдк.

    Исправлен вылет при попытке переместить предмет.
    
    Исправлен неудобный баг, из-за которого object list обрезался.

    Изменены некоторые иконки на топ баре.
    ...
    Добавлен тхм генератор для террейнов, благодаря которому были исправлены проблемы с .thm файлами из-за которых террейн мылился. (подробнее в вики).
    ...
    Добавлена расширенная аи сетка.

    Добавлен InGame режим [Спасибо Roman-n!]

    Улучшен Gizmo.

    Расширен инструментарий для добавления травы на локацию.
